...
class TestRobinProperties:
    ...
    def test_robin_exclude_order_property(self, num_parts: int, from_part: int) -> None:
...
class TestSlNodeProperties:
    ...
    def test_slnode_initial_state_property(self, data: int) -> None:
    ...
    def test_slnode_linking_property(self, data1: int, data2: int) -> None:
